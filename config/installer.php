    ...
    'environment' => [
        'form' => [
            'rules' => [
                ...
                'create_account_name'   => 'required|string|max:50',
                'create_account_email'  => 'required|email|max:50',
                'create_account_password' => ['required', 'min:8', 'regex:/^.*(?=.{3,})(?=.*[a-zA-Z])(?=.*[0-9])(?=.*[\d\x]).*$/','confirmed'],
                'create_account_password_confirmation' => 'required|string|max:50'
            ],
        ],
    ],
