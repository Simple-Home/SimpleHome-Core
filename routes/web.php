...
Route::namespace('settings')->prefix('settings')->group(function () {
    ...
    Route::middleware(['auth', 'verified', 'language'])->get('/settings/integrations', [App\Http\Controllers\SettingsController::class, 'integrations'])->name('integrations_list');
    Route::middleware(['auth', 'verified', 'language'])->get('/settings/integrations/detail/{integration_slug}', [App\Http\Controllers\SettingsController::class, 'detail'])->name('integration_detail');
