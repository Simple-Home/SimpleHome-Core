...
<div class="row">
    ...
    <div class="col">
      <div class="row row-cols-1 row-cols-md-3">
        ...
        <div class="card-body">
        APACHE: <span
        class="{{ !$services['apache2'] ? 'text-danger' : 'text-success' }}">{{($services["apache2"]? "Active" : "Not Active")}}</span><br>
        MYSQL: <span
        class="{{ !$services['mysql'] ? 'text-danger' : 'text-success' }}">{{($services["mysql"] ? "Active" : "Not Active")}}</span><br>
        </div>
        </div>
        </div>
        <div class="col mb-4">
