...
<head>
    ...
    <script src="{{ asset(mix('js/manifest.js'), (Request::server('HTTP_X_FORWARDED_PROTO') != 'http' ? true : '')) }}"></script>
    <script src="{{ asset(mix('js/vendor.js'), (Request::server('HTTP_X_FORWARDED_PROTO') != 'http' ? true : '')) }}"></script>
