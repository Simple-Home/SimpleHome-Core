...
<a href="{{ route('device.control', [$property->device->hostname , "batt", "ON"]) }}" title="On" class="btn btn-primary"><i class="fas fa-power-off"></i></a>
<a href="{{ route('device.control', [$property->device->hostname , "batt", "OFF"]) }}" title="Off" class="btn btn-danger"><i class="fas fa-power-off"></i></a>