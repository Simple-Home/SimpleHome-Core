    ...
    <div class="row">
        <div class="col mb-3">
            <button type="button" class="automation-type btn btn-primary btn-lg w-100 text-start"
                data-url="{{ route('automations.form.type.save.ajax') }}" data-automation-type="manual">
    ...
    <div class="row">
        <div class="col">
            <div class="btn-group-vertical  w-100">
                ...
                <button type="button" class="automation-type btn btn-primary btn-lg w-100 text-start"
                    data-url="{{ route('automations.form.type.save.ajax') }}" data-automation-type="state_change">
