        ...
        <form method="post" action="{{ route('LaravelInstaller::environmentSaveWizard') }}" class="tabs-wrap">
            <div class="tab" id="tab1content">
                ...
                <div class="form-group {{ $errors->has('app_name') ? ' has-error ' : '' }}">
                    ...
                    <input type="text" name="app_name" id="app_name" value="Simple Home" placeholder="{{ trans('installer_messages.environment.wizard.form.app_name_placeholder') }}" />
            ...
            <div class="tab" id="tab3content">
                <div>
                    <div class="form-group {{ $errors->has('create_account_name') ? ' has-error ' : '' }}">
                        ...
                        <input type="text" name="create_account_name" id="create_account_app_id" value="" placeholder="{{ trans('installer_messages.environment.wizard.form.app_tabs.create_account_name_palceholder') }}" />
                    ...
                    <div class="form-group {{ $errors->has('create_account_email') ? ' has-error ' : '' }}">
                        ...
                        <input type="text" name="create_account_email" id="create_account_email" value="" placeholder="{{ trans('installer_messages.environment.wizard.form.app_tabs.create_account_email_palceholder') }}" />
                    ...
                    <div class="form-group {{ $errors->has('create_account_password') ? ' has-error ' : '' }}">
                        ...
                        <input type="password" name="create_account_password" id="create_account_password" value="" placeholder="{{ trans('installer_messages.environment.wizard.form.app_tabs.create_account_password_palceholder') }}" />
                    ...
                    <div class="form-group {{ $errors->has('create_account_password_confirmation') ? ' has-error ' : '' }}">
                        ...
                        <input type="password" name="create_account_password_confirmation" id="create_account_password_confirmation" value="" placeholder="{{ trans('installer_messages.environment.wizard.form.app_tabs.create_account_password_confirmation_palceholder') }}" />
                ...
                <div class="block margin-bottom-2">
                    ...
                    <input type="hidden" name="pusher_app_key" id="pusher_app_key" value="" placeholder="{{ trans('installer_messages.environment.wizard.form.app_tabs.pusher_app_key_palceholder') }}" />
                    <input type="hidden" name="pusher_app_secret" id="pusher_app_secret" value="" placeholder="{{ trans('installer_messages.environment.wizard.form.app_tabs.pusher_app_secret_palceholder') }}" />
                </div>
                <div class="buttons">
