        ...
        <form method="post" action="{{ route('LaravelInstaller::environmentSaveWizard') }}" class="tabs-wrap">
            <div class="tab" id="tab1content">
                ...
                <div class="form-group {{ $errors->has('app_name') ? ' has-error ' : '' }}">
                    ...
                    <input type="text" name="app_name" id="app_name" value="Simple Home"
                ...
                <div class="form-group {{ $errors->has('mail_driver') ? ' has-error ' : '' }}">
                    <label for="mail_driver">
                        {{ trans('installer_messages.environment.wizard.form.app_tabs.mail_driver_placeholder') }}
                    </label>
                    <input type="text" name="mail_driver" id="mail_driver" value=""
                ...
                <div class="form-group {{ $errors->has('mail_host') ? ' has-error ' : '' }}">
                    <label for="mail_host">
                        {{ trans('installer_messages.environment.wizard.form.app_tabs.mail_host_placeholder') }}
                    </label>
                    <input type="text" name="mail_host" id="mail_host" value=""
                ...
                <div class="form-group {{ $errors->has('mail_port') ? ' has-error ' : '' }}">
                    <label for="mail_port">
                        {{ trans('installer_messages.environment.wizard.form.app_tabs.mail_port_placeholder') }}
                    </label>
                ...
                <div class="form-group {{ $errors->has('mail_username') ? ' has-error ' : '' }}">
                    <label for="mail_username">
                        {{ trans('installer_messages.environment.wizard.form.app_tabs.mail_username_placeholder') }}                    </label>
                    <input type="text" name="mail_username" id="mail_username" value=""
                ...
                <div class="form-group {{ $errors->has('mail_password') ? ' has-error ' : '' }}">
                    <label for="mail_password">
                        {{ trans('installer_messages.environment.wizard.form.app_tabs.mail_password_placeholder') }}
                    </label>
                ...
                <div class="form-group {{ $errors->has('mail_encryption') ? ' has-error ' : '' }}">
                    <label for="mail_encryption">
                        {{ trans('installer_messages.environment.wizard.form.app_tabs.mail_encryption_placeholder') }}
                    </label>
                ...
                <div class="buttons">
                    <button id="setup_database" class="button" onclick="showDatabaseSettings();return false">
            ...
            <div class="tab" id="tab2content">
                ...
                <div class="buttons">
                    <button id="setup_account" class="button" onclick="showApplicationSettings();return false">
            ...
            <div class="tab" id="tab3content">
                <div>
                    <div class="form-group {{ $errors->has('create_account_name') ? ' has-error ' : '' }}">
                        <label for="pusher_app_id">
                            {{ trans('installer_messages.environment.wizard.form.app_tabs.create_account_name_label') }}
                        </label>
                        <input type="text" name="create_account_name" id="create_account_app_id" value=""
                               placeholder="{{ trans('installer_messages.environment.wizard.form.app_tabs.create_account_name_palceholder') }}"/>
                        @if ($errors->has('create_account_name'))
                            <span class="error-block">
                                <i class="fa fa-fw fa-exclamation-triangle" aria-hidden="true"></i>
                                {{ $errors->first('create_account_name') }}
                            </span>
                        @endif
                    </div>

                    <div class="form-group {{ $errors->has('create_account_email') ? ' has-error ' : '' }}">
                        <label for="create_account_email">{{ trans('installer_messages.environment.wizard.form.app_tabs.create_account_email_label') }}</label>
                        <input type="text" name="create_account_email" id="create_account_email" value=""
                               placeholder="{{ trans('installer_messages.environment.wizard.form.app_tabs.create_account_email_palceholder') }}"/>
                        @if ($errors->has('create_account_email'))
                            <span class="error-block">
                                <i class="fa fa-fw fa-exclamation-triangle" aria-hidden="true"></i>
                                {{ $errors->first('create_account_email') }}
                            </span>
                        @endif
                    </div>

                    <div class="form-group {{ $errors->has('create_account_password') ? ' has-error ' : '' }}">
                        <label for="create_account_password">{{ trans('installer_messages.environment.wizard.form.app_tabs.create_account_password_label') }}</label>
                        <input type="password" name="create_account_password" id="create_account_password" value=""
                               placeholder="{{ trans('installer_messages.environment.wizard.form.app_tabs.create_account_password_palceholder') }}"/>
                        @if ($errors->has('create_account_password'))
                            <span class="error-block">
                                <i class="fa fa-fw fa-exclamation-triangle" aria-hidden="true"></i>
                                {{ $errors->first('create_account_password') }}
                            </span>
                        @endif
                    </div>

                    <div class="form-group {{ $errors->has('create_account_password_confirmation') ? ' has-error ' : '' }}">
                        <label for="create_account_password_confirmation">{{ trans('installer_messages.environment.wizard.form.app_tabs.create_account_password_confirmation_label') }}</label>
                        <input type="password" name="create_account_password_confirmation"
                               id="create_account_password_confirmation" value=""
                               placeholder="{{ trans('installer_messages.environment.wizard.form.app_tabs.create_account_password_confirmation_palceholder') }}"/>
                        @if ($errors->has('create_account_password_confirmation'))
                            <span class="error-block">
                                <i class="fa fa-fw fa-exclamation-triangle" aria-hidden="true"></i>
                                {{ $errors->first('create_account_password_confirmation') }}
                            </span>
                        @endif
                    </div>
                </div>
                ...
                <div class="buttons">
                    <button id="start_install" class="button" type="submit">
